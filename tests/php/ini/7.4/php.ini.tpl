...
;open_basedir                   = "D:/other/OSPanel/home;D:/other/OSPanel/temp;D:/other/OSPanel/data/PHP-7.4/default/composer"
...
;auto_append_file               =
;auto_prepend_file              =
;browscap                       = "D:/other/OSPanel/user/browscap/lite_php_browscap.ini"
cli_server.color                = On
...
blackfire.log_file              = {blackfire.log_file}
...
geoip.custom_directory          = {geoip.custom_directory}
...
seaslog.default_basepath        = {seaslog.default_basepath}
...
; Apache + mod_php (only)
uploadprogress.file.contents_template = {uploadprogress.file.contents_template}
uploadprogress.file.filename_template = {uploadprogress.file.filename_template}
;uploadprogress.get_contents    = 0

[xhprof]

;xhprof.collect_additional_info = 0
xhprof.output_dir               = {xhprof.output_dir}
...
xdebug.output_dir               = {xdebug.output_dir}
