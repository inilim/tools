...
class limitTest extends TestCase
{
    function test()
    {
        ...
        $this->assertSame('Explosion is a...', Str::limit('Explosion is a free, open source PHP web application tools.', 15, '...', true));
        ...
        $this->assertSame('The PHP tools for web artisans.', Str::limit($string, 100, '...', true));
        $this->assertSame('The PHP tools...', Str::limit($string, 20, '...', true));
