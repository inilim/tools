...
declare(strict_types=1);namespace Inilim\Tool\Method\Obj{function sprintfLogicException(string $format='',array $values=[],array $args=[]):\LogicException{return \Inilim\Tool\Method\Obj\sprintfException($format,$values,\LogicException :: class,$args);}if(!\Inilim\Tool\Obj::__definedIfNot('rewriteLocationException')){
