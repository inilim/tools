...
namespace Inilim\Tool\Method\Assert{function existSqliteLib(string $message=''){if(!\Inilim\Tool\Method\Check\existSqliteLib()){throw new \InvalidArgumentException($message?:'SQLite library not exist');}}}namespace Inilim\Tool\Method\Other{if(!\Inilim\Tool\Other::__definedIfNot('__setErrorLast')){
