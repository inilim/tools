...
declare(strict_types=1);namespace Inilim\Tool\Method\Assert{function existSqliteLib(string $message=''){if(!\Inilim\Tool\Method\Check\existSqliteLib()){throw new \InvalidArgumentException($message?:'SQLite library not exist');}}}namespace Inilim\Tool\Method\Other{if(!\Inilim\Tool\Other::__definedIfNot('__setErrorLast')){
    ...
    }}namespace Inilim\Tool\Method\Check{if(!\Inilim\Tool\Check::__definedIfNot('existSqliteLib')){
    function existSqliteLib():bool{return \Inilim\Tool\Method\Other\sqliteLibVersion()!==null;}
    }}