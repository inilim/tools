...
namespace Inilim\Tool\Method\Assert{function boolean($value,string $message=''){if(!\is_bool($value)){throw new \InvalidArgumentException(\sprintf($message?:'Expected a bool. Got: %s',\Inilim\Tool\Method\Other\getType($value)));}}}namespace Inilim\Tool\Method\Other{if(!\Inilim\Tool\Other::__definedIfNot('getType')){
