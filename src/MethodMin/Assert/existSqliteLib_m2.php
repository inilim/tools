...
namespace Inilim\Tool\Method\Assert{function existSqliteLib_m2(string $message=''){if(!\Inilim\Tool\Method\Check\existSqliteLib_m2()){throw new \InvalidArgumentException($message?:'SQLite library not exist');}}}namespace Inilim\Tool\Method\Other{if(!\Inilim\Tool\Other::__definedIfNot('__setErrorLast')){
    ...
    }}namespace Inilim\Tool\Method\Check{if(!\Inilim\Tool\Check::__definedIfNot('existSqliteLib_m2')){
    function existSqliteLib_m2():bool{return \Inilim\Tool\Method\Other\sqliteLibVersion_m2()!==null;}
    }}