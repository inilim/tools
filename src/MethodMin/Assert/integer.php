...
namespace Inilim\Tool\Method\Assert{function integer($value,string $message=''){if(!\is_int($value)){throw new \InvalidArgumentException(\sprintf($message?:'Expected an integer. Got: %s',\Inilim\Tool\Method\Other\getType($value)));}}}namespace Inilim\Tool\Method\Other{if(!\Inilim\Tool\Other::__definedIfNot('getType')){
