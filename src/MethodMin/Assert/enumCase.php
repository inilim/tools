...
namespace Inilim\Tool\Method\Assert{function enumCase($value,string $message=''){if(!\Inilim\Tool\Method\Check\enumCase($value)){throw new \InvalidArgumentException(\sprintf($message?:'Expected an \UnitEnum. Got: %s',\Inilim\Tool\Method\Other\valueToString($value)));}}}namespace Inilim\Tool\Method\Other{if(!\Inilim\Tool\Other::__definedIfNot('getType')){
