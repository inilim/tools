...
namespace Inilim\Tool\Method\Assert{function positiveFloat($value,string $message=''){if(!\Inilim\Tool\Method\Check\positiveFloat($value)){throw new \InvalidArgumentException(\sprintf($message?:'Expected a positive float. Got: %s',\Inilim\Tool\Method\Other\valueToString($value)));}}}namespace Inilim\Tool\Method\Other{if(!\Inilim\Tool\Other::__definedIfNot('getType')){
    ...
    }}namespace Inilim\Tool\Method\Check{if(!\Inilim\Tool\Check::__definedIfNot('positiveFloat')){
