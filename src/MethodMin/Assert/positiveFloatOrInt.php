...
namespace Inilim\Tool\Method\Assert{function positiveFloatOrInt($value,string $message=''){if(!\Inilim\Tool\Method\Check\positiveFloatOrInt($value)){throw new \InvalidArgumentException(\sprintf($message?:'Expected a positive float or integer. Got: %s',\Inilim\Tool\Method\Other\valueToString($value)));}}}namespace Inilim\Tool\Method\Other{if(!\Inilim\Tool\Other::__definedIfNot('getType')){
    ...
    }}namespace Inilim\Tool\Method\Check{if(!\Inilim\Tool\Check::__definedIfNot('positiveFloatOrInt')){
