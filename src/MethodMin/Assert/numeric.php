...
namespace Inilim\Tool\Method\Assert{function numeric($value,string $message=''){if(!\is_numeric($value)){throw new \InvalidArgumentException(\sprintf($message?:'Expected a numeric. Got: %s',\Inilim\Tool\Method\Other\getType($value)));}}}namespace Inilim\Tool\Method\Other{if(!\Inilim\Tool\Other::__definedIfNot('getType')){
