...
namespace Inilim\Tool\Method\Assert{function natural($value,string $message=''){if(!\Inilim\Tool\Method\Check\natural($value)){throw new \InvalidArgumentException(\sprintf($message?:'Expected a non-negative integer. Got: %s',\Inilim\Tool\Method\Other\valueToString($value)));}}}namespace Inilim\Tool\Method\Other{if(!\Inilim\Tool\Other::__definedIfNot('funcPhp')){
