...
declare(strict_types=1);namespace Inilim\Tool\Method\Assert{function strOrArr($value,string $message=''){if(!\Inilim\Tool\Method\Check\strOrArr($value)){throw new \InvalidArgumentException(\sprintf($message?:'Expected a string or array. Got: %s',\Inilim\Tool\Method\Other\getType($value)));}}}namespace Inilim\Tool\Method\Other{if(!\Inilim\Tool\Other::__definedIfNot('getType')){
    ...
    }}namespace Inilim\Tool\Method\Check{if(!\Inilim\Tool\Check::__definedIfNot('strOrArr')){
