...
declare(strict_types=1);namespace Inilim\Tool\Method\Enum{function count($enum):int{return \sizeof(\Inilim\Tool\Method\Enum\cases($enum));}if(!\Inilim\Tool\Enum::__definedIfNot('cases')){
