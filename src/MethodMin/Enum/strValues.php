...
namespace Inilim\Tool\Method\Enum{function strValues($enum){return \Inilim\Tool\Method\Enum\typeValues($enum)==='string';}if(!\Inilim\Tool\Enum::__definedIfNot('cases')){
