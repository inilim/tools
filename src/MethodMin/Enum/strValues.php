...
declare(strict_types=1);namespace Inilim\Tool\Method\Enum{function strValues($enum):bool{return \Inilim\Tool\Method\Enum\typeValues($enum)==='string';}if(!\Inilim\Tool\Enum::__definedIfNot('cases')){
