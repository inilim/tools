...
namespace Inilim\Tool\Method\Enum{function last($enum){return \Inilim\Tool\Method\Arr\last(\Inilim\Tool\Method\Enum\cases($enum));}if(!\Inilim\Tool\Enum::__definedIfNot('cases')){
    ...
    function last(iterable $array,?callable $callback=null,$default=null){if($callback===null){return empty($array)?\Inilim\Tool\Method\Arr\value($default):\end($array);}return \Inilim\Tool\Method\Arr\head(\array_reverse($array,true),$callback,$default);}
