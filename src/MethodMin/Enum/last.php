...
declare(strict_types=1);namespace Inilim\Tool\Method\Enum{function last($enum){return \Inilim\Tool\Method\Arr\last(\Inilim\Tool\Method\Enum\cases($enum));}if(!\Inilim\Tool\Enum::__definedIfNot('cases')){
