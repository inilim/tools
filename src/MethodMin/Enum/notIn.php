...
declare(strict_types=1);namespace Inilim\Tool\Method\Enum{function notIn(object $enum,array $haystack):bool{return!\Inilim\Tool\Method\Enum\in($enum,$haystack);}if(!\Inilim\Tool\Enum::__definedIfNot('in')){
