...
namespace Inilim\Tool\Method\Enum{function notIn(object $enum,array $haystack){return!\Inilim\Tool\Method\Enum\in($enum,$haystack);}if(!\Inilim\Tool\Enum::__definedIfNot('in')){
