...
namespace Inilim\Tool\Method\Enum{function isNot(object $enum,object $needle){return!\Inilim\Tool\Method\Enum\is($enum,$needle);}if(!\Inilim\Tool\Enum::__definedIfNot('in')){
    ...
    function is(object $enum,object $needle){\Inilim\Tool\Method\Assert\enumCase($needle);return \Inilim\Tool\Method\Enum\in($enum,[$needle]);}
