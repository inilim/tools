...
declare(strict_types=1);namespace Inilim\Tool\Method\Enum{function isNot(object $enum,object $needle):bool{return!\Inilim\Tool\Method\Enum\is($enum,$needle);}if(!\Inilim\Tool\Enum::__definedIfNot('in')){
