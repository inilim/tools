...
declare(strict_types=1);namespace Inilim\Tool\Method\Enum{function values($enum):array{return \array_column(\Inilim\Tool\Method\Enum\cases($enum),'value');}if(!\Inilim\Tool\Enum::__definedIfNot('cases')){
