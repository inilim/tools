...
namespace Inilim\Tool\Method\Enum{function values($enum){return \array_column(\Inilim\Tool\Method\Enum\cases($enum),'value');}if(!\Inilim\Tool\Enum::__definedIfNot('cases')){
