...
declare(strict_types=1);namespace Inilim\Tool\Method\Enum{function intValues($enum):bool{return \Inilim\Tool\Method\Enum\typeValues($enum)==='int';}if(!\Inilim\Tool\Enum::__definedIfNot('cases')){
