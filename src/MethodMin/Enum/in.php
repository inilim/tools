...
namespace Inilim\Tool\Method\Enum{function in(object $enum,array $haystack){\Inilim\Tool\Method\Assert\enumCase($enum);foreach($haystack as $item){if($enum===$item){return true;}}return false;}if(!\Inilim\Tool\Enum::__definedIfNot('isCase')){
