...
namespace Inilim\Tool\Method\Enum{function options($enum):array{$cases=\Inilim\Tool\Method\Enum\cases($enum);if(isset($cases[0]-> value)){return \array_column($cases,'value','name');}return \array_column($cases,'name');}if(!\Inilim\Tool\Enum::__definedIfNot('cases')){
