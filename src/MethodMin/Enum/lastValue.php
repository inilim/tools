...
declare(strict_types=1);namespace Inilim\Tool\Method\Enum{function lastValue($enum){$case=\Inilim\Tool\Method\Enum\last($enum);return $case -> value ?? null;}if(!\Inilim\Tool\Enum::__definedIfNot('cases')){
