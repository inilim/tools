...
namespace Inilim\Tool\Method\File{function getViaArray(array $params){return \Inilim\Tool\Method\File\get($params['pathToFile'],$params['offset']?? 0,$params['length']?? null,$params['useIncludePath']?? false,$params['throw']?? false,$params['context']?? null,$params['contextParams']?? null);}if(!\Inilim\Tool\File::__definedIfNot('get')){
