...
namespace Inilim\Tool\Method\File{function lines_v2(string $pathToFile):\Generator{\Inilim\Tool\Method\Assert\file($pathToFile);$file=new \SplFileObject($pathToFile);$file -> setFlags(\SplFileObject :: DROP_NEW_LINE);while(!$file -> eof()){yield $file -> fgets();}}}namespace Inilim\Tool\Method\Other{if(!\Inilim\Tool\Other::__definedIfNot('getType')){
