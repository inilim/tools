...
declare(strict_types=1);namespace Inilim\Tool\Method\File{function jsonViaArray(array $params){return \Inilim\Tool\Method\File\json($params['pathToFile'],$params['flags']?? 0,$params['lock']?? false,$params['throw']?? false,$params['default']?? null);}if(!\Inilim\Tool\File::__definedIfNot('get')){
