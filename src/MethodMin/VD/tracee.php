...
namespace Inilim\Tool\Method\VD{function tracee(int $limit=0,bool $ignoreArgs=true){$options=\DEBUG_BACKTRACE_PROVIDE_OBJECT;if($ignoreArgs){$options |= \DEBUG_BACKTRACE_IGNORE_ARGS;}\Inilim\Tool\Method\VD\de(\debug_backtrace($options,$limit));}if(!\Inilim\Tool\VD::__definedIfNot('d')){
