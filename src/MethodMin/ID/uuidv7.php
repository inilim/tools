...
namespace Inilim\Tool\Method\ID{function uuidv7():string{$uhex=\substr(\str_pad(\dechex(\Inilim\Tool\Method\Time\unixMs()),12,'0',\STR_PAD_LEFT),-12);$uhex .= \bin2hex(\random_bytes(10));return \Inilim\Tool\Method\ID\uuidFromHex($uhex,7);}if(!\Inilim\Tool\ID::__definedIfNot('uuidFromHex')){
