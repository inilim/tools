...
namespace Inilim\Tool\Method\FS{function makeDirViaArray(array $params):array{return \Inilim\Tool\Method\FS\makeDir($params['path'],$params['throw']?? false,$params['mode']?? 0755,$params['recursive']?? false,$params['force']?? false,$params['context']?? null,$params['contextParams']?? null);}if(!\Inilim\Tool\FS::__definedIfNot('makeDir')){
