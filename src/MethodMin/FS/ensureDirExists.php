...
declare(strict_types=1);namespace Inilim\Tool\Method\FS{function ensureDirExists(string $path,bool $throw=false,int $mode=0755,bool $recursive=true,$context=null,?array $contextParams=null):array{if(\is_dir($path)){return['result'=>true,'exception'=>null];}return \Inilim\Tool\Method\FS\makeDir($path,$throw,$mode,$recursive,false,$context,$contextParams);}if(!\Inilim\Tool\FS::__definedIfNot('makeDir')){
