...
namespace Inilim\Tool\Method\PF{function ctype_upper($text):bool{if(\Inilim\Tool\Method\Other\funcPhp('ctype_upper')){return \ctype_upper($text);}$cls=\Inilim\Tool\Method\PF\__resourceCache('ctype_upper');return $cls($text);}if(!\Inilim\Tool\PF::__definedIfNot('__resource')){
