...
namespace Inilim\Tool\Method\PF{function ctype_xdigit($text):bool{if(\Inilim\Tool\Method\Other\funcPhp('ctype_xdigit')){return \ctype_xdigit($text);}$cls=\Inilim\Tool\Method\PF\__resourceCache('ctype_xdigit');return $cls($text);}if(!\Inilim\Tool\PF::__definedIfNot('__resource')){
