...
declare(strict_types=1);namespace Inilim\Tool\Method\PF{function ctype_xdigit($text):bool{if(\Inilim\Tool\Method\Other\funcPhp('ctype_xdigit')){return \ctype_xdigit($text);}$cls=\Inilim\Tool\Method\Other\__resourceCache(__FUNCTION__,'convert_int_to_char_for_ctype');$text=$cls -> __invoke($text,'ctype_xdigit');return \is_string($text)&&''!==$text&&!\preg_match('/[^A-Fa-f0-9]/',$text);}}namespace Inilim\Tool\Method\Other{if(!\Inilim\Tool\Other::__definedIfNot('__resource')){
