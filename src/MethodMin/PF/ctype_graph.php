...
declare(strict_types=1);namespace Inilim\Tool\Method\PF{function ctype_graph($text):bool{if(\Inilim\Tool\Method\Other\funcPhp('ctype_graph')){return \ctype_graph($text);}$cls=\Inilim\Tool\Method\Other\__resourceCache(__FUNCTION__,'convert_int_to_char_for_ctype');$text=$cls -> __invoke($text,'ctype_graph');return \is_string($text)&&''!==$text&&!\preg_match('/[^!-~]/',$text);}}namespace Inilim\Tool\Method\Other{if(!\Inilim\Tool\Other::__definedIfNot('__resource')){
