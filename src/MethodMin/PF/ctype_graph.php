...
namespace Inilim\Tool\Method\PF{function ctype_graph($text):bool{if(\Inilim\Tool\Method\Other\funcPhp('ctype_graph')){return \ctype_graph($text);}$cls=\Inilim\Tool\Method\PF\__resourceCache('ctype_graph');return $cls($text);}if(!\Inilim\Tool\PF::__definedIfNot('__resource')){
