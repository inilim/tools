...
namespace Inilim\Tool\Method\PF{function ctype_space($text):bool{if(\Inilim\Tool\Method\Other\funcPhp('ctype_space')){return \ctype_space($text);}$cls=\Inilim\Tool\Method\PF\__resourceCache('ctype_space');return $cls($text);}if(!\Inilim\Tool\PF::__definedIfNot('__resource')){
