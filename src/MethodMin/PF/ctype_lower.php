...
namespace Inilim\Tool\Method\PF{function ctype_lower($text):bool{if(\Inilim\Tool\Method\Other\funcPhp('ctype_lower')){return \ctype_lower($text);}$cls=\Inilim\Tool\Method\PF\__resourceCache('ctype_lower');return $cls($text);}if(!\Inilim\Tool\PF::__definedIfNot('__resource')){
