...
namespace Inilim\Tool\Method\PF{function ctype_digit($text):bool{if(\Inilim\Tool\Method\Other\funcPhp('ctype_digit')){return \ctype_digit($text);}$cls=\Inilim\Tool\Method\PF\__resourceCache('ctype_digit');return $cls($text);}if(!\Inilim\Tool\PF::__definedIfNot('__resource')){
