...
namespace Inilim\Tool\Method\PF{function ctype_print($text):bool{if(\Inilim\Tool\Method\Other\funcPhp('ctype_print')){return \ctype_print($text);}$cls=\Inilim\Tool\Method\PF\__resourceCache('ctype_print');return $cls($text);}if(!\Inilim\Tool\PF::__definedIfNot('__resource')){
