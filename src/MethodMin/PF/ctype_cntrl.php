...
declare(strict_types=1);namespace Inilim\Tool\Method\PF{function ctype_cntrl($text):bool{if(\Inilim\Tool\Method\Other\funcPhp('ctype_cntrl')){return \ctype_cntrl($text);}$cls=\Inilim\Tool\Method\Other\__resourceCache(__FUNCTION__,'convert_int_to_char_for_ctype');$text=$cls -> __invoke($text,'ctype_cntrl');return \is_string($text)&&''!==$text&&!\preg_match('/[^\x00-\x1f\x7f]/',$text);}}namespace Inilim\Tool\Method\Other{if(!\Inilim\Tool\Other::__definedIfNot('__resource')){
