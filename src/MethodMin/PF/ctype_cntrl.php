...
namespace Inilim\Tool\Method\PF{function ctype_cntrl($text):bool{if(\Inilim\Tool\Method\Other\funcPhp('ctype_cntrl')){return \ctype_cntrl($text);}$cls=\Inilim\Tool\Method\PF\__resourceCache('ctype_cntrl');return $cls($text);}if(!\Inilim\Tool\PF::__definedIfNot('__resource')){
