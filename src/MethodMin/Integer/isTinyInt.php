...
namespace Inilim\Tool\Method\Integer{function isTinyInt($value):bool{if(!\Inilim\Tool\Method\Integer\isNumeric($value)){return false;}$value=\strval($value);if(\Inilim\Tool\Method\Integer\lenNumeric($value)>\Inilim\Tool\Integer :: TINY_INT_MAX_LENGHT){return false;}return checkBetween($value,\Inilim\Tool\Integer :: TINY_INT_MIN,\Inilim\Tool\Integer :: TINY_INT_MAX);}if(!\Inilim\Tool\Integer::__definedIfNot('isNumeric')){
