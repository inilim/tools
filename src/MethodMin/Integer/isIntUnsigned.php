...
namespace Inilim\Tool\Method\Integer{function isIntUnsigned($value):bool{if(!\Inilim\Tool\Method\Integer\isNumeric($value)){return false;}$value=\strval($value);if(\Inilim\Tool\Method\PF\str_starts_with($value,'-')){return false;}$len=\Inilim\Tool\Method\Integer\lenNumeric($value);if($len<\Inilim\Tool\Integer :: MAX_LEN_32_BIT){return true;}if($len>\Inilim\Tool\Integer :: MAX_LEN_32_BIT){return false;}return \Inilim\Tool\Method\Integer\__compare(\str_split($value),[4,2,9,4,9,6,7,2,9,5]);}if(!\Inilim\Tool\Integer::__definedIfNot('__compare')){
