...
namespace Inilim\Tool\Method\Integer{function isIntUnsigned($value){if(!\Inilim\Tool\Method\Integer\isNumeric($value)){return false;}/**@varint|string$value*/$value=\strval($value);/**@varstring$value*/if(\Inilim\Tool\Method\String\_startsWith($value,'-')){return false;}$len=\Inilim\Tool\Method\Integer\lenNumeric($value);if($len<\Inilim\Tool\Integer :: MAX_LEN_32_BIT){return true;}if($len>\Inilim\Tool\Integer :: MAX_LEN_32_BIT){return false;}/*// длина 10*/return \Inilim\Tool\Method\Integer\__compare(\str_split($value),[4,2,9,4,9,6,7,2,9,5]);}if(!\Inilim\Tool\Integer::__definedIfNot('__compare')){
    ...
    }}namespace Inilim\Tool\Method\String{if(!\Inilim\Tool\Str::__definedIfNot('_startsWith')){
