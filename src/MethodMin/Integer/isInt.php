...
namespace Inilim\Tool\Method\Integer{function isInt($value){if(!\Inilim\Tool\Method\Integer\isNumeric($value)){return false;}/**@varint|string$value*/$value=\strval($value);/**@varstring$value*/$len=\Inilim\Tool\Method\Integer\lenNumeric($value);if($len<\Inilim\Tool\Integer :: MAX_LEN_32_BIT){return true;}if($len>\Inilim\Tool\Integer :: MAX_LEN_32_BIT){return false;}/*// длина 10*/$last=\Inilim\Tool\Method\String\_startsWith($value,'-')?8:7;return \Inilim\Tool\Method\Integer\__compare(\str_split(\ltrim($value,'-')),[2,1,4,7,4,8,3,6,4,$last]);}if(!\Inilim\Tool\Integer::__definedIfNot('__compare')){
