...
namespace Inilim\Tool\Method\Integer{function isSmallInt($value){if(!\Inilim\Tool\Method\Integer\isNumeric($value)){return false;}$value=\strval($value);if(\Inilim\Tool\Method\Integer\lenNumeric($value)>\Inilim\Tool\Integer :: SMALL_INT_MAX_LENGHT){return false;}return \Inilim\Tool\Method\Integer\checkBetween($value,\Inilim\Tool\Integer :: SMALL_INT_MIN,\Inilim\Tool\Integer :: SMALL_INT_MAX);}if(!\Inilim\Tool\Integer::__definedIfNot('checkBetween')){
