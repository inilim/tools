...
namespace Inilim\Tool\Method\Integer{function forHumans($number,int $precision=0,?int $maxPrecision=null,bool $abbreviate=false){return \Inilim\Tool\Method\Integer\__summarize($number,$precision,$maxPrecision,$abbreviate?[3=>'K',6=>'M',9=>'B',12=>'T',15=>'Q']:[3=>' thousand',6=>' million',9=>' billion',12=>' trillion',15=>' quadrillion']);}if(!\Inilim\Tool\Integer::__definedIfNot('__state')){
