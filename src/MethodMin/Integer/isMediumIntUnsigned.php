...
namespace Inilim\Tool\Method\Integer{function isMediumIntUnsigned(mixed $value){if(!\Inilim\Tool\Method\Integer\isNumeric($value)){return false;}/**@varint|float|string$value*/$value=\strval($value);/**@varstring$value*/if(\Inilim\Tool\Method\Integer\lenNumeric($value)>\Inilim\Tool\Integer :: MEDIUM_INT_UNSIGNED_MAX_LENGHT){return false;}return \Inilim\Tool\Method\Integer\checkBetween($value,\Inilim\Tool\Integer :: MEDIUM_INT_UNSIGNED_MIN,\Inilim\Tool\Integer :: MEDIUM_INT_UNSIGNED_MAX);}if(!\Inilim\Tool\Integer::__definedIfNot('checkBetween')){
