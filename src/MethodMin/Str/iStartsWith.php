...
namespace Inilim\Tool\Method\Str{function iStartsWith(string $haystack,$needles,bool $ignoreCase=false):bool{return \Inilim\Tool\Method\Str\startsWith($haystack,$needles,true);}if(!\Inilim\Tool\Str::__definedIfNot('startsWith')){
