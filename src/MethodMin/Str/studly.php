...
namespace Inilim\Tool\Method\Str{function studly(string $value){$words=\explode(' ',\Inilim\Tool\Method\Str\replace(['-','_'],' ',$value));$studlyWords=\array_map('\Inilim\Tool\Method\Str\ucfirst',$words);return \implode($studlyWords);}if(!\Inilim\Tool\Str::__definedIfNot('replace')){
