...
declare(strict_types=1);namespace Inilim\Tool\Method\Str{function chopEnd(string $subject,$needle):string{foreach((array) $needle as $n){if(\Inilim\Tool\Method\PF\str_ends_with($subject,$n)){return \substr($subject,0,-\strlen($n));}}return $subject;}}namespace Inilim\Tool\Method\Check{if(!\Inilim\Tool\Check::__definedIfNot('php80')){
