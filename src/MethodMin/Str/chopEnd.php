...
namespace Inilim\Tool\Method\Str{function chopEnd(string $subject,$needle):string{foreach((array) $needle as $n){if(\Inilim\Tool\Method\Str\_endsWith($subject,$n)){return \substr($subject,0,-\strlen($n));}}return $subject;}if(!\Inilim\Tool\Str::__definedIfNot('_endsWith')){
