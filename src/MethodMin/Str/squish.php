...
declare(strict_types=1);namespace Inilim\Tool\Method\Str{function squish(string $value){return \preg_replace('#(\s|\x{3164}|\x{1160})+#u',' ',\Inilim\Tool\Method\Str\trim($value));}if(!\Inilim\Tool\Str::__definedIfNot('trim')){
