...
declare(strict_types=1);namespace Inilim\Tool\Method\Str{function getSegmentPath(string $path,int $segment):?string{return \Inilim\Tool\Method\Str\getSegmentsPath($path)[$segment]?? null;}if(!\Inilim\Tool\Str::__definedIfNot('__state')){
    ...
    }if(!\Inilim\Tool\Str::__definedIfNot('getSegmentsPath')){
