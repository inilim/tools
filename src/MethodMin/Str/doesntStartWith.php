...
namespace Inilim\Tool\Method\Str{function doesntStartWith(string $haystack,$needles):bool{return!\Inilim\Tool\Method\Str\startsWith($haystack,$needles);}if(!\Inilim\Tool\Str::__definedIfNot('startsWith')){
