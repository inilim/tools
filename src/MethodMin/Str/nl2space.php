...
declare(strict_types=1);namespace Inilim\Tool\Method\Str{function nl2space(string $str,string $replace=' ',bool $squish=false):string{$str=\str_replace(["\r\n","\n\r","\n","\r"],$replace,$str);return $squish?\Inilim\Tool\Method\Str\squish($str):$str;}if(!\Inilim\Tool\Str::__definedIfNot('__state')){
    ...
    }if(!\Inilim\Tool\Str::__definedIfNot('squish')){
