...
namespace Inilim\Tool\Method\Str{function _endsWith(string $haystack,string $needle){return \Inilim\Tool\Method\PF\str_ends_with($haystack,$needle);}}namespace Inilim\Tool\Method\Check{if(!\Inilim\Tool\Check::__definedIfNot('php80')){
