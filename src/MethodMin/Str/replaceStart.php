...
namespace Inilim\Tool\Method\Str{function replaceStart(string $search,string $replace,string $subject){if($search===''){return $subject;}if(\Inilim\Tool\Method\Str\startsWith($subject,$search)){return \Inilim\Tool\Method\Str\replaceFirst($search,$replace,$subject);}return $subject;}if(!\Inilim\Tool\Str::__definedIfNot('_startsWith')){
