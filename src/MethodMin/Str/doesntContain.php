...
namespace Inilim\Tool\Method\Str{function doesntContain(string $haystack,$needles,bool $ignoreCase=false){return!\Inilim\Tool\Method\Str\contains($haystack,$needles,$ignoreCase);}if(!\Inilim\Tool\Str::__definedIfNot('contains')){
