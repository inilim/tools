...
namespace Inilim\Tool\Method\Str{function iEndsWith(string $haystack,$needles){if(!\is_iterable($needles)){$needles=[$needles];}foreach($needles as&$needle){$needle=\Inilim\Tool\Method\Str\lower($needle);}return \Inilim\Tool\Method\Str\endsWith(\Inilim\Tool\Method\Str\lower($haystack),$needles);}if(!\Inilim\Tool\Str::__definedIfNot('endsWith')){
