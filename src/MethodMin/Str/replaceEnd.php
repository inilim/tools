...
namespace Inilim\Tool\Method\Str{function replaceEnd(string $search,string $replace,string $subject):string{if($search===''){return $subject;}if(\Inilim\Tool\Method\Str\endsWith($subject,$search)){return \Inilim\Tool\Method\Str\replaceLast($search,$replace,$subject);}return $subject;}if(!\Inilim\Tool\Str::__definedIfNot('_endsWith')){
