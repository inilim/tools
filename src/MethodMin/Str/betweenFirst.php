...
namespace Inilim\Tool\Method\Str{function betweenFirst(string $subject,string $from,string $to):string{if($from===''||$to===''){return $subject;}return \Inilim\Tool\Method\Str\before(\Inilim\Tool\Method\Str\after($subject,$from),$to);}if(!\Inilim\Tool\Str::__definedIfNot('after')){
