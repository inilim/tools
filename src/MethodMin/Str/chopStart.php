...
namespace Inilim\Tool\Method\Str{function chopStart(string $subject,$needle):string{foreach((array) $needle as $n){if(\Inilim\Tool\Method\PF\str_starts_with($subject,$n)){return \substr($subject,\strlen($n));}}return $subject;}}namespace Inilim\Tool\Method\Check{if(!\Inilim\Tool\Check::__definedIfNot('php80')){
