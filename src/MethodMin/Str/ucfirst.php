...
namespace Inilim\Tool\Method\Str{function ucfirst(string $string){return \Inilim\Tool\Method\Str\upper(\Inilim\Tool\Method\Str\substr($string,0,1)).\Inilim\Tool\Method\Str\substr($string,1);}if(!\Inilim\Tool\Str::__definedIfNot('substr')){
