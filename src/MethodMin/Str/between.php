...
declare(strict_types=1);namespace Inilim\Tool\Method\Str{function between(string $subject,string $from,string $to):string{if($from===''||$to===''){return $subject;}return \Inilim\Tool\Method\Str\beforeLast(\Inilim\Tool\Method\Str\after($subject,$from),$to);}if(!\Inilim\Tool\Str::__definedIfNot('after')){
