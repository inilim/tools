...
namespace Inilim\Tool\Method\Str{function _contains(string $haystack,string $needle){return \Inilim\Tool\Method\PF\str_contains($haystack,$needle);}}namespace Inilim\Tool\Method\Check{if(!\Inilim\Tool\Check::__definedIfNot('php80')){
