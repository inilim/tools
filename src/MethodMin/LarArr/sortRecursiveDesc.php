...
namespace Inilim\Tool\Method\LarArr{function sortRecursiveDesc($array,$options=\SORT_REGULAR){return \Inilim\Tool\Method\LarArr\sortRecursive($array,$options,true);}if(!\Inilim\Tool\LarArr::__definedIfNot('sortRecursive')){
