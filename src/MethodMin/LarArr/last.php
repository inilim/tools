...
namespace Inilim\Tool\Method\LarArr{function last($array,?callable $callback=null,$default=null){if(\is_null($callback)){return empty($array)?\Inilim\Tool\Method\Lar\value($default):\Inilim\Tool\Method\PF\array_last($array);}return \Inilim\Tool\Method\LarArr\first(\array_reverse($array,true),$callback,$default);}if(!\Inilim\Tool\LarArr::__definedIfNot('first')){
