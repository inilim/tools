...
namespace Inilim\Tool\Method\LarArr{function pull():\Closure{\Inilim\Tool\Method\Assert\__notArgsHere(__FUNCTION__,\func_num_args());return static function(&$array,$key,$default=null){$value=\Inilim\Tool\Method\LarArr\get($array,$key,$default);\Inilim\Tool\Method\LarArr\forget()($array,$key);return $value;};}if(!\Inilim\Tool\LarArr::__definedIfNot('accessible')){
