...
namespace Inilim\Tool\Method\Json{function isJsonAsObject(?string $v){if($v===null){return false;}$v=\Inilim\Tool\Method\Json\decode($v);if(\Inilim\Tool\Method\Json\hasError()){return false;}return \is_object($v);}if(!\Inilim\Tool\Json::__definedIfNot('decode')){
