...
namespace Inilim\Tool\Method\Json{function tryDecodeAsArrList(?string $v,$default=null){if($v===null){return $default;}$v=\Inilim\Tool\Method\Json\decode($v);if(\is_array($v)&&\Inilim\Tool\Method\LarArr\isList($v)){return $v;}return $default;}if(!\Inilim\Tool\Json::__definedIfNot('decode')){
    ...
    }}namespace Inilim\Tool\Method\LarArr{if(!\Inilim\Tool\LarArr::__definedIfNot('isList')){
    function isList($array){return \Inilim\Tool\Method\PF\array_is_list($array);}
    }}