...
declare(strict_types=1);namespace Inilim\Tool\Method\Json{function isJson(?string $v):bool{if($v===null){return false;}return \Inilim\Tool\Method\PF\json_validate($v);}}namespace Inilim\Tool\Method\Check{if(!\Inilim\Tool\Check::__definedIfNot('php83')){
