...
namespace Inilim\Tool\Method\Check{function contains($value,string $subString,bool $ingnoreCase=false):bool{return \is_string($value)&&($ingnoreCase?\Inilim\Tool\Method\Str\iContainsOnce($value,$subString):\Inilim\Tool\Method\PF\str_contains($value,$subString));}if(!\Inilim\Tool\Check::__definedIfNot('php80')){
