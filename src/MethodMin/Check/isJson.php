...
declare(strict_types=1);namespace Inilim\Tool\Method\Check{function isJson($value):bool{if(!\is_string($value)){return false;}return \Inilim\Tool\Method\PF\json_validate($value);}if(!\Inilim\Tool\Check::__definedIfNot('php83')){
