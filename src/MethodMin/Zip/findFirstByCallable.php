...
namespace Inilim\Tool\Method\Zip{function findFirstByCallable($pathToFileOrZip,callable $predicate):?array{foreach(\Inilim\Tool\Method\Zip\scanAsGenerator($pathToFileOrZip)as $stat){$t=$stat;if($predicate($t)===true){return $stat;}}return null;}if(!\Inilim\Tool\Zip::__definedIfNot('getObjFrom')){
