...
namespace Inilim\Tool\Method\Zip{function scan($pathToFileOrZip):array{return \iterator_to_array(\Inilim\Tool\Method\Zip\scanAsGenerator($pathToFileOrZip),false);}if(!\Inilim\Tool\Zip::__definedIfNot('getObjFrom')){
