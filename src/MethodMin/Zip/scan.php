...
namespace Inilim\Tool\Method\Zip{function scan($pathToFileOrZip):?array{$gen=\Inilim\Tool\Method\Zip\scanAsGenerator($pathToFileOrZip);if($gen===null){return null;}return \iterator_to_array($gen,false);}if(!\Inilim\Tool\Zip::__definedIfNot('getObjFrom')){
