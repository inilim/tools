...
namespace Inilim\Tool\Method\Zip{function findFirstResourceByCallable($pathToFileOrZip,callable $predicate){$zip=\Inilim\Tool\Method\Zip\getObjFrom($pathToFileOrZip);if($zip===null){return null;}$find=\Inilim\Tool\Method\Zip\findFirstByCallable($zip,$predicate);if($find===null){return null;}return \Inilim\Tool\Method\Zip\getResourceByIdx($zip,$find['index']);}if(!\Inilim\Tool\Zip::__definedIfNot('findFirstByCallable')){
