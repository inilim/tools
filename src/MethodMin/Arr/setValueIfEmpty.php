...
namespace Inilim\Tool\Method\Arr{function setValueIfEmpty():\CLosure{\Inilim\Tool\Method\Assert\__notArgsHere(__FUNCTION__,\func_num_args());return static function(array&$array,string $key,$value):bool{$cur=\Inilim\Tool\Method\LarArr\get($array,$key,-1);if(\in_array($cur,[null,'',[]],true)){\Inilim\Tool\Method\LarArr\set()($array,$key,$value);return true;}return false;};}}namespace Inilim\Tool\Method\Assert{if(!\Inilim\Tool\Assert::__definedIfNot('__notArgsHere')){
