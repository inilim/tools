...
namespace Inilim\Tool\Method\Arr{function setValueIfEmpty(){if(\func_num_args()!==0){throw new \InvalidArgumentException('setValueIfEmpty()(...) <-- The arguments were passed to the wrong place');}return static function(array&$array,string $key,$value){$cur=\Inilim\Tool\Method\Arr\get($array,$key,-1);if(\in_array($cur,[null,'',[]],true)){\Inilim\Tool\Method\Arr\set()($array,$key,$value);return true;}return false;};}if(!\Inilim\Tool\Arr::__definedIfNot('accessible')){
