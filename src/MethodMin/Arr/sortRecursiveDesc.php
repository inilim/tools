...
namespace Inilim\Tool\Method\Arr{function sortRecursiveDesc(array $array,int $options=\SORT_REGULAR):array{return \Inilim\Tool\Method\LarArr\sortRecursive($array,$options,true);}}namespace Inilim\Tool\Method\Check{if(!\Inilim\Tool\Check::__definedIfNot('php81')){
