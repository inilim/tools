...
namespace Inilim\Tool\Method\Arr{function setValueIfNotExists():\Closure{if(\func_num_args()!==0){throw new \InvalidArgumentException('setValueIfNotExists()(...) <-- The arguments were passed to the wrong place');}return static function(array&$array,string $key,$value):bool{if(!\Inilim\Tool\Method\Arr\has($array,$key)){\Inilim\Tool\Method\Arr\set()($array,$key,$value);return true;}return false;};}if(!\Inilim\Tool\Arr::__definedIfNot('accessible')){
