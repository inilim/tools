...
namespace Inilim\Tool\Method\Arr{function setValueIfNotExists(array&$array,string $key,$value){if(!\Inilim\Tool\Method\Arr\has($array,$key)){\Inilim\Tool\Method\Arr\set($array,$key,$value);return true;}return false;}if(!\Inilim\Tool\Arr::__definedIfNot('accessible')){
