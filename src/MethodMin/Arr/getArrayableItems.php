...
namespace Inilim\Tool\Method\Arr{function getArrayableItems($items):array{if($items===null){return[];}elseif(\is_scalar($items)||\Inilim\Tool\Method\Check\php81()&&$items instanceof \UnitEnum){return \Inilim\Tool\Method\LarArr\wrap($items);}return \Inilim\Tool\Method\Arr\from($items);}if(!\Inilim\Tool\Arr::__definedIfNot('from')){
