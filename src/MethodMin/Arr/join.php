...
declare(strict_types=1);namespace Inilim\Tool\Method\Arr{function join(array $array,string $glue,string $finalGlue=''):string{if($finalGlue===''){return \implode($glue,$array);}if(!$array){return '';}if(\sizeof($array)===1){return \Inilim\Tool\Method\PF\array_last($array);}$finalItem=\array_pop($array);return \implode($glue,$array).$finalGlue.$finalItem;}}namespace Inilim\Tool\Method\Check{if(!\Inilim\Tool\Check::__definedIfNot('php85')){
