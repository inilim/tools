...
namespace Inilim\Tool\Method\Arr{function except(array $array,$keys):array{\Inilim\Tool\Method\LarArr\forget()($array,$keys);return $array;}}namespace Inilim\Tool\Method\Assert{if(!\Inilim\Tool\Assert::__definedIfNot('__notArgsHere')){
