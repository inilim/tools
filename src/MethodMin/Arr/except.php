...
declare(strict_types=1);namespace Inilim\Tool\Method\Arr{function except(array $array,$keys):array{\Inilim\Tool\Method\Arr\forget()($array,$keys);return $array;}if(!\Inilim\Tool\Arr::__definedIfNot('exists')){
