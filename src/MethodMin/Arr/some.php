...
namespace Inilim\Tool\Method\Arr{function some(iterable $array,callable $callback):bool{return \Inilim\Tool\Method\PF\array_any($array,$callback);}}namespace Inilim\Tool\Method\Check{if(!\Inilim\Tool\Check::__definedIfNot('php84')){
