...
namespace Inilim\Tool\Method\Arr{function hasAll($array,$keys):bool{$keys=(array) $keys;if(!$array||$keys===[]){return false;}foreach($keys as $key){if(!\Inilim\Tool\Method\LarArr\has($array,$key)){return false;}}return true;}}namespace Inilim\Tool\Method\LarArr{if(!\Inilim\Tool\LarArr::__definedIfNot('accessible')){
