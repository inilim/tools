...
namespace Inilim\Tool\Method\Arr{function add(array $array,$key,$value){if(\is_float($key)){$key=(string) $key;}if(\Inilim\Tool\Method\LarArr\get($array,$key)===null){\Inilim\Tool\Method\LarArr\set()($array,$key,$value);}return $array;}}namespace Inilim\Tool\Method\Assert{if(!\Inilim\Tool\Assert::__definedIfNot('__notArgsHere')){
