...
namespace Inilim\Tool\Method\Arr{function hasValueAny(array $array,$values,bool $strict=false):bool{$values=\Inilim\Tool\Method\Arr\wrap($values);if(!$array||!$values){return false;}foreach($values as $value){if(\Inilim\Tool\Method\Arr\hasValue($array,$value,$strict)){return true;}}return false;}if(!\Inilim\Tool\Arr::__definedIfNot('hasValue')){
