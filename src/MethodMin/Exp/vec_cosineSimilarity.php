...
declare(strict_types=1);namespace Inilim\Tool\Method\Exp{function vec_cosineSimilarity(array $vectorA,array $vectorB):float{[$vectorA,$normA]=\Inilim\Tool\Method\Exp\vec_normalize($vectorA);[$vectorB,$normB]=\Inilim\Tool\Method\Exp\vec_normalize($vectorB);$sim=\Inilim\Tool\Method\Exp\vec_dotProduct($vectorA,$vectorB)/($normA*$normB);return \round((float) $sim,2);}if(!\Inilim\Tool\Exp::__definedIfNot('vec_dotProduct')){
