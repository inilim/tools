...
namespace Inilim\Tool\Method\String{function iEndsWith(string $haystack,$needles){if(!\is_iterable($needles)){$needles=[$needles];}foreach($needles as&$needle){$needle=\Inilim\Tool\Method\String\lower($needle);}return \Inilim\Tool\Method\String\endsWith(\Inilim\Tool\Method\String\lower($haystack),$needles);}if(!\Inilim\Tool\Str::__definedIfNot('_endsWith')){
