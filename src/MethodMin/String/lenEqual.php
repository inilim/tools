...
namespace Inilim\Tool\Method\String{function lenEqual(string $str,$equal){return \Inilim\Tool\Method\Integer\equals(\Inilim\Tool\Method\String\length($str),$equal);}if(!\Inilim\Tool\Str::__definedIfNot('length')){
