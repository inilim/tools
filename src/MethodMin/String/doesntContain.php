...
namespace Inilim\Tool\Method\String{function doesntContain(string $haystack,$needles,bool $ignoreCase=false){return!\Inilim\Tool\Method\String\contains($haystack,$needles,$ignoreCase);}if(!\Inilim\Tool\Str::__definedIfNot('_contains')){
