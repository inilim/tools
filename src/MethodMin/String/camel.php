...
namespace Inilim\Tool\Method\String{function camel(string $value):string{return \lcfirst(\Inilim\Tool\Method\String\studly($value));}if(!\Inilim\Tool\Str::__definedIfNot('replace')){
    ...
    function studly(string $value):string{$words=\explode(' ',\Inilim\Tool\Method\String\replace(['-','_'],' ',$value));$studly_words=\array_map(static fn($word)=>\Inilim\Tool\Method\String\ucfirst($word),$words);return \implode($studly_words);}
