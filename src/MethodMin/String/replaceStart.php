...
namespace Inilim\Tool\Method\String{function replaceStart(string $search,string $replace,string $subject):string{if($search===''){return $subject;}if(\Inilim\Tool\Method\String\startsWith($subject,$search)){return \Inilim\Tool\Method\String\replaceFirst($search,$replace,$subject);}return $subject;}if(!\Inilim\Tool\Str::__definedIfNot('_startsWith')){
