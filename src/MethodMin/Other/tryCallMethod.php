...
declare(strict_types=1);namespace Inilim\Tool\Method\Other{function tryCallMethod($objectOrClass,string $methodName,array $args=[],$default=null){return \Inilim\Tool\Method\Other\tryCallCallable([$objectOrClass,$methodName],$args,$default);}if(!\Inilim\Tool\Other::__definedIfNot('_refDots')){
