...
namespace Inilim\Tool\Method\Other{function colorHexToAnsi(string $hex):int{$r=\Inilim\Tool\Method\Other\colorHexToRgb($hex);return (int)(16+\round($r['red']/51)*36+\round($r['green']/51)*6+\round($r['blue']/51));}if(!\Inilim\Tool\Other::__definedIfNot('colorHexToRgb')){
